...
class MainContent(QObject):
    ...
    def __do_download_extract_release_to_tempdir(self, url: str) -> None:
        with ZipFile(BytesIO(requests.get(url, timeout=10).content)) as zipobj:
    ...
    def _do_configure_github_identity(self) -> None:
        ...
        args, ok = QInputDialog().getText(
            None, # type: ignore # Is okay to set parent to None
            self.tr("Edit username"),
            self.tr("Enter your Github username:"),
        ...
        args, ok = QInputDialog().getText(
            None, # type: ignore # Is okay to set parent to None
            self.tr("Edit token"),
            self.tr("Enter your Github personal access token here (ghp_*):"),
