...
# nuitka-project-if: os.path.exists("{MAIN_DIRECTORY}/../themes/default-icons/AppIcon_alt.ico"):
#   nuitka-project: --include-data-file={MAIN_DIRECTORY}/../themes/default-icons/AppIcon_alt.ico=icon.ico
